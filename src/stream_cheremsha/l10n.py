...
_TABLE: dict[str, dict[AppLocale, str]] = {
    ...
    # Tab docks (multichat / activity / online served via overlay server)
    "dock.multichat.title": {"uk": "Мультичат", "en": "MultiChat"},
    "dock.activity.title": {"uk": "Активність", "en": "Activity"},
    "dock.online.title": {"uk": "Онлайн", "en": "Online"},
    "dock.connected": {"uk": "підключено", "en": "connected"},
    "dock.connecting": {"uk": "підключення…", "en": "connecting…"},
    "dock.disconnected": {"uk": "відключено", "en": "disconnected"},
    "dock.error": {"uk": "помилка", "en": "error"},
    "dock.reconnecting_in": {"uk": "перепідключення через {s}с…", "en": "reconnecting in {s}s…"},
    "dock.jump": {"uk": "До останніх", "en": "Jump to latest"},
    "dock.follow": {"uk": "підписка", "en": "follow"},
    "dock.sub": {"uk": "підписка (sub)", "en": "sub"},
    "dock.resub": {"uk": "повторна підписка", "en": "resub"},
    "dock.gift": {"uk": "подарунок", "en": "gift"},
    "dock.join": {"uk": "зайшов(ла)", "en": "joined"},
    "dock.like": {"uk": "лайки", "en": "likes"},
    "dock.share": {"uk": "шер", "en": "shares"},
    "dock.superchat": {"uk": "суперчат", "en": "super chat"},
    "dock.supersticker": {"uk": "стікер", "en": "sticker"},
    "dock.member": {"uk": "учасник", "en": "member"},
    "dock.event": {"uk": "подія", "en": "event"},
    "dock.sep": {"uk": " · ", "en": " · "},
    "dock.current": {"uk": "Зараз", "en": "Current"},
    "dock.peak": {"uk": "Пік", "en": "Peak"},
    "dock.total": {"uk": "Всього", "en": "Total"},
    "dock.gifts": {"uk": "Подарунки", "en": "Gifts"},
    "dock.diamonds": {"uk": "Діаманти", "en": "Diamonds"},
    "dock.messages": {"uk": "Повідомлення", "en": "Messages"},
    "dock.unique": {"uk": "Унікальні", "en": "Unique"},
    "dock.super": {"uk": "Суперчати", "en": "Super Chats"},
    "dock.members": {"uk": "Підписки", "en": "Memberships"},
    "dock.follows": {"uk": "Фолови", "en": "Follows"},
    "dock.subs": {"uk": "Саби", "en": "Subs"},
    "dock.gift_subs": {"uk": "Подарункові саби", "en": "Gift subs"},
    "dock.kicks": {"uk": "KICKS", "en": "KICKS"},
    "dock.updated_at": {"uk": "оновлено: {s}", "en": "updated: {s}"},
    # Docks tab (QML DocksView)
    "docksview.header_title": {"uk": "Доки", "en": "Docks"},
    "docksview.header_subtitle": {"uk": "Веб-доки для стримінгу", "en": "Web docks for streaming"},
    "docksview.header_hint": {
        "uk": "Використовуйте ці посилання у будь-якому стрімінговому софті або відкрийте у браузері.",
        "en": "Use these links in any streaming software or open them in a browser.",
    },
    "docksview.public_access": {"uk": "Публічний доступ", "en": "Public access"},
    "docksview.public_hint": {
        "uk": "Дозволяє використовувати ваші веб-доки через зовнішню мережу.",
        "en": "Allows using your web docks over the external network.",
    },
    "docksview.enabled": {"uk": "Увімкнено", "en": "Enabled"},
    "docksview.disabled": {"uk": "Вимкнено", "en": "Disabled"},
    "docksview.copy_url": {"uk": "Копіювати URL", "en": "Copy URL"},
    "docksview.open": {"uk": "Відкрити", "en": "Open"},
    "docksview.available_title": {"uk": "Доступні веб-доки", "en": "Available web docks"},
    "docksview.available_hint": {
        "uk": "Готові джерела для вашого стріму. Скопіюйте URL і додайте у ваш стрімінговий софт.",
        "en": "Ready sources for your stream. Copy the URL and add it to your streaming software.",
    },
    "docksview.count": {"uk": "{n} доки", "en": "{n} docks"},
    "docksview.web_dock_badge": {"uk": "Веб-док", "en": "Web dock"},
    "docksview.multichat_desc": {
        "uk": "Чат з усіх підключених платформ в одному вікні. Підтримує Twitch, YouTube, TikTok, Kick та інші.",
        "en": "Chat from all connected platforms in one window. Supports Twitch, YouTube, TikTok, Kick and more.",
    },
    "docksview.activity_desc": {
        "uk": "Останні події: підписки, донати, подарунки, рейди та інша активність у реальному часі.",
        "en": "Latest events: subscriptions, donations, gifts, raids and other activity in real time.",
    },
    "docksview.online_desc": {
        "uk": "Показує поточний онлайн, глядачів з усіх платформ та загальну статистику стріму.",
        "en": "Shows current online, viewers across all platforms and overall stream stats.",
    },
    "docksview.how_title": {"uk": "Як це працює?", "en": "How does it work?"},
    "docksview.how_hint": {
        "uk": "Коротка інструкція з використання веб-доків.",
        "en": "A quick guide to using web docks.",
    },
    "docksview.step1_title": {"uk": "Скопіюйте URL", "en": "Copy the URL"},
    "docksview.step1_hint": {
        "uk": "Натисніть кнопку «Копіювати URL» біля потрібного доку.",
        "en": "Click the “Copy URL” button next to the dock you need.",
    },
    "docksview.step2_title": {
        "uk": "Додайте у стрімінговий софт",
        "en": "Add to your streaming software",
    },
    "docksview.step2_hint": {
        "uk": "Вставте URL як Browser Source у ваш софт.",
        "en": "Paste the URL as a Browser Source in your software.",
    },
    "docksview.step3_title": {"uk": "Готово!", "en": "Done!"},
    "docksview.step3_hint": {
        "uk": "Док буде автоматично оновлюватися в реальному часі.",
        "en": "The dock will update automatically in real time.",
    },
    "docksview.not_available": {
        "uk": "Docks API is not available yet.",
        "en": "Docks API is not available yet.",
    },
    # Docks tab preview mock labels (illustrative card previews)
    "docksview.preview_sub": {"uk": "Підписка", "en": "Subscription"},
    "docksview.preview_donation": {"uk": "Донат $5", "en": "$5 donation"},
    "docksview.preview_gift": {"uk": "Подарунок", "en": "Gift"},
    "docksview.preview_raid": {"uk": "Рейд ×42", "en": "Raid ×42"},
    "docksview.preview_online": {"uk": "Онлайн", "en": "Online"},
    "docksview.preview_viewers": {"uk": "Глядачі", "en": "Viewers"},
    "docksview.preview_followers": {"uk": "Підписники", "en": "Followers"},
    # Updates
    ...
    "actions.rule_one_action": {"uk": "1 дія", "en": "1 action"},
    "actions.rule_n_actions": {"uk": "%1 дії", "en": "%1 actions"},
    "actions.rule_enabled": {"uk": "Увімкнено", "en": "Enabled"},
    "actions.rule_disabled": {"uk": "Вимкнено", "en": "Disabled"},
    "actions.rule_more_tt": {"uk": "Ще дії", "en": "More actions"},
    "actions.library_subtitle": {
        "uk": "Автоматизація подій стріму",
        "en": "Stream event automation",
    },
    "actions.search_ph": {"uk": "Пошук правил…", "en": "Search rules…"},
    "actions.filter_all": {"uk": "Усі", "en": "All"},
    "actions.filter_folders": {"uk": "Папки", "en": "Folders"},
    "actions.filter_unfiled": {"uk": "Без папки", "en": "Without folder"},
    "actions.section_pinned": {"uk": "Закріплені", "en": "Pinned"},
    "actions.section_unfiled": {"uk": "Без папки", "en": "Without folder"},
    "actions.new_rule_default_name": {"uk": "Нове правило", "en": "New rule"},
    "actions.empty_title": {
        "uk": "Дії автоматизують ваш стрім",
        "en": "Actions automate your stream",
    },
    "actions.empty_body": {
        "uk": "Створіть правило, яке автоматично реагує на події чату, подарунки, підписки та інші події.",
    ...
    "actions.when_subtitle": {
        "uk": "Виберіть подію, яка буде запускати правило",
        "en": "Choose the event that will trigger the rule",
    },
    "actions.triggers_label_when": {"uk": "Коли відбувається:", "en": "When happens:"},
    "actions.when_platform_label": {"uk": "Платформа", "en": "Platform"},
    "actions.when_event_label": {"uk": "Тип події", "en": "Event type"},
    "actions.then_title": {"uk": "Що зробити?", "en": "What should happen?"},
    "actions.then_subtitle": {
    ...
    "actions.action_group_sound": {"uk": "ЗВУК", "en": "SOUND"},
    "actions.action_group_voice": {"uk": "ГОЛОС ТА ОВЕРЛЕЙ", "en": "VOICE & OVERLAY"},
    "actions.action_group_obs": {"uk": "OBS", "en": "OBS"},
    "actions.action_group_system": {"uk": "СИСТЕМА", "en": "SYSTEM"},
    "actions.picker_title": {"uk": "Додати дію", "en": "Add action"},
    "actions.picker_search_ph": {"uk": "Пошук дій…", "en": "Search actions…"},
    "actions.unsaved_dot": {"uk": "● Незбережені зміни", "en": "● Unsaved changes"},
    "actions.cancel_btn": {"uk": "Скасувати", "en": "Cancel"},
    "actions.save_changes": {"uk": "Зберегти зміни", "en": "Save changes"},
    "actions.sum_word": {"uk": "Слово «%1»", "en": "Word “%1”"},
    "actions.sum_actions_suffix": {"uk": "%1 дія", "en": "%1 action"},
    "actions.desc_prefix": {"uk": "Реагує на ", "en": "Reacts to "},
    "actions.desc_word_in_chat": {"uk": "слово «%1» у чаті", "en": "the word “%1” in chat"},
    "actions.desc_and": {"uk": " та ", "en": " and "},
    "actions.desc_no_actions": {"uk": " (додайте дію нижче)", "en": " (add an action below)"},
    "actions.verb_play_sound": {"uk": "програє звук", "en": "plays a sound"},
    "actions.verb_play_random": {"uk": "програє випадковий звук", "en": "plays a random sound"},
    "actions.verb_speak_tts": {"uk": "озвучує текст", "en": "speaks text"},
    "actions.verb_show_overlay": {"uk": "показує оверлей", "en": "shows the overlay"},
    "actions.verb_obs": {"uk": "керує OBS", "en": "controls OBS"},
    "actions.verb_write_file": {"uk": "пише у файл", "en": "writes to a file"},
    "actions.verb_run_program": {"uk": "запускає програму", "en": "runs a program"},
    "actions.verb_keystrokes": {"uk": "натискає клавіші", "en": "presses keys"},
    "actions.verb_n_actions": {"uk": "виконує %1 дії", "en": "runs %1 actions"},
    "actions.action_desc_play_sound": {"uk": "Відтворює аудіофайл", "en": "Plays an audio file"},
    "actions.action_desc_play_random": {
        "uk": "Випадковий звук із сервісу",
        "en": "Random sound from the service",
    },
    "actions.action_desc_speak_tts": {"uk": "Озвучує текст голосом", "en": "Speaks text aloud"},
    "actions.action_desc_show_overlay": {
        "uk": "Показує текст в оверлеї",
        "en": "Shows text on the overlay",
    },
    "actions.action_desc_obs": {"uk": "Керує сценою OBS", "en": "Controls the OBS scene"},
    "actions.action_desc_write_file": {"uk": "Записує текст у файл", "en": "Writes text to a file"},
    "actions.action_desc_run_program": {"uk": "Запускає програму", "en": "Launches a program"},
    "actions.action_desc_keystrokes": {
        "uk": "Імітує натискання клавіш",
    ...
    "actions.folder_rename": {"uk": "Перейменувати", "en": "Rename"},
    "actions.folder_menu_tt": {"uk": "Дії з папкою", "en": "Folder actions"},
    ...
    "actions.add_or_trigger_tt": {
        "uk": "Додати альтернативний тригер (АБО)",
        "en": "Add alternative trigger (OR)",
    },
    ...
    "actions.event.donate": {
        "uk": "Донат (Donatik / Donatello)",
        "en": "Donate (Donatik / Donatello)",
    },
    ...
    "actions.keyword": {"uk": "Слово або фраза", "en": "Word or phrase"},
    ...
    "widgets.battle_royale.section_general": {"uk": "Загальні", "en": "General"},
    "widgets.battle_royale.section_appearance": {"uk": "Вигляд", "en": "Appearance"},
    "widgets.battle_royale.section_behavior": {
        "uk": "Геймплей / поведінка",
        "en": "Gameplay / Behavior",
    },
    "widgets.battle_royale.section_advanced": {"uk": "Розширені", "en": "Advanced"},
    "widgets.battle_royale.desc_general": {
        "uk": "Основні налаштування цього інстансу.",
        "en": "Core settings for this widget instance.",
    },
    "widgets.battle_royale.desc_appearance": {
        "uk": "Візуальне оформлення та відображення.",
        "en": "Visual presentation and display options.",
    },
    "widgets.battle_royale.desc_behavior": {
        "uk": "Правила, час і поведінка віджета.",
        "en": "Rules, timing, and widget behavior.",
    },
    "widgets.battle_royale.desc_advanced": {
        "uk": "Розширені налаштування віджета.",
        "en": "Advanced widget settings.",
    },
    "widgets.battle_royale.hide_when_idle": {"uk": "Ховати без бою", "en": "Hide when idle"},
    "widgets.battle_royale.max_hp": {"uk": "Максимальне HP", "en": "Maximum HP"},
    "widgets.battle_royale.round_duration": {"uk": "Тривалість раунду", "en": "Round duration"},
    "widgets.battle_royale.critical_threshold": {
        "uk": "Поріг критичної атаки",
        "en": "Critical threshold",
    },
    "widgets.battle_royale.gifts_per_fighter": {
        "uk": "Подарунків на бійця",
        "en": "Gifts per fighter",
    },
    "widgets.battle_royale.auto_start": {"uk": "Автостарт", "en": "Auto start"},
    "widgets.battle_royale.base_font_size": {"uk": "Базовий розмір шрифту", "en": "Base font size"},
    "widgets.battle_royale.scale_percent": {"uk": "Масштаб (%)", "en": "Scale (%)"},
    "widgets.battle_royale.automatic_threshold": {
        "uk": "Автоматичний поріг",
        "en": "Automatic threshold",
    },
    "widgets.battle_royale.automatic_window": {
        "uk": "Автоматичне вікно (секунди)",
        "en": "Automatic window (seconds)",
    },
    "widgets.battle_royale.preset": {"uk": "Пресет", "en": "Preset"},
    "widgets.battle_royale.title": {"uk": "Заголовок", "en": "Title"},
    "widgets.battle_royale.countdown": {"uk": "Зворотний відлік", "en": "Countdown"},
    "widgets.battle_royale.critical_multiplier": {
        "uk": "Множник критичної атаки",
        "en": "Critical multiplier",
    },
    "widgets.battle_royale.max_fighters": {"uk": "Максимум бійців", "en": "Maximum fighters"},
    "widgets.battle_royale.vip_chat_hours": {"uk": "Години VIP-чату", "en": "VIP chat hours"},
    "widgets.battle_royale.avatar_size": {"uk": "Розмір аватара", "en": "Avatar size"},
    "widgets.battle_royale.font_family": {"uk": "Сімейство шрифту", "en": "Font family"},
    "widgets.battle_royale.animation_intensity": {
        "uk": "Інтенсивність анімації",
        "en": "Animation intensity",
    },
    "widgets.battle_royale.sfx_volume": {"uk": "Гучність SFX", "en": "SFX volume"},
    "widgets.battle_royale.projectile_animation": {
        "uk": "Анімація снарядів",
        "en": "Projectile animation",
    },
    "widgets.battle_royale.shake_animation": {"uk": "Анімація тремтіння", "en": "Shake animation"},
    "widgets.battle_royale.critical_flash": {"uk": "Критичний спалах", "en": "Critical flash"},
    "widgets.battle_royale.fatality_animation": {
        "uk": "Анімація фаталіті",
        "en": "Fatality animation",
    },
    "widgets.battle_royale.preset_arcade_royale": {
        "uk": "Аркадна королівська битва",
        "en": "Arcade Royale",
    },
    "widgets.battle_royale.preset_cyber_arena": {"uk": "Кібер-арена", "en": "Cyber Arena"},
    "widgets.battle_royale.preset_dark_fight": {"uk": "Темний бій", "en": "Dark Fight"},
    "widgets.battle_royale.preset_minimal_brawl": {
        "uk": "Мінімальна сутичка",
        "en": "Minimal Brawl",
    },
    # 1v1 Battle widget (TikTok-gift race, best-of rounds)
    "widgets.battle.section_general": {"uk": "Основні налаштування", "en": "General"},
    "widgets.battle.desc_general": {
        "uk": "Назва та базові правила 1v1-битви.",
        "en": "Name and basic 1v1 battle rules.",
    },
    "widgets.battle.battle_name": {"uk": "Назва", "en": "Name"},
    "widgets.battle.best_of": {"uk": "Формат", "en": "Best of"},
    "widgets.battle.round_duration": {
        "uk": "Тривалість раунду (сек)",
        "en": "Round duration (sec)",
    },
    "widgets.battle.countdown": {"uk": "Зворотний відлік (сек)", "en": "Countdown (sec)"},
    "widgets.battle.auto_start": {"uk": "Авто-старт", "en": "Auto-start"},
    "widgets.battle.auto_threshold": {"uk": "Авто-поріг", "en": "Auto threshold"},
    "widgets.battle.auto_window": {"uk": "Авто-вікно (секунди)", "en": "Auto window (seconds)"},
    "widgets.battle.auto_reset": {"uk": "Авто-перезапуск", "en": "Auto-reset"},
    "widgets.battle.section_appearance": {"uk": "Зовнішній вигляд", "en": "Appearance"},
    "widgets.battle.desc_appearance": {
        "uk": "Візуальна подача та масштаб.",
        "en": "Visual presentation and scale.",
    },
    "widgets.battle.theme": {"uk": "Тема", "en": "Theme"},
    "widgets.battle.layout_mode": {"uk": "Розташування", "en": "Layout"},
    "widgets.battle.show_avatars": {"uk": "Показувати аватари", "en": "Show avatars"},
    "widgets.battle.scale": {"uk": "Масштаб (%)", "en": "Scale (%)"},
    "widgets.battle.font_size": {"uk": "Розмір шрифту", "en": "Font size"},
    "widgets.battle.section_behavior": {"uk": "Поведінка", "en": "Behavior"},
    "widgets.battle.desc_behavior": {
        "uk": "Очки, комбо, камбек та фінальний пуш.",
        "en": "Points, combos, comeback and final push.",
    },
    "widgets.battle.gift_multiplier": {"uk": "Множник подарунків", "en": "Gift multiplier"},
    "widgets.battle.combo_enabled": {"uk": "Комбо", "en": "Combo"},
    "widgets.battle.combo_threshold": {"uk": "Поріг комбо", "en": "Combo threshold"},
    "widgets.battle.comeback_enabled": {"uk": "Камбек", "en": "Comeback"},
    "widgets.battle.final_push": {"uk": "Фінальний пуш (секунди)", "en": "Final push (seconds)"},
    "widgets.battle.event_animations": {"uk": "Анімації подій", "en": "Event animations"},
    "widgets.battle.animation_intensity": {
        "uk": "Інтенсивність анімації",
        "en": "Animation intensity",
    },
    "widgets.battle.show_badges": {"uk": "Знаки подій", "en": "Show event badges"},
    "widgets.battle.show_winner": {"uk": "Екран перемоги", "en": "Show winner screen"},
    "widgets.battle.victory_display": {
        "uk": "Показ перемоги (секунди)",
        "en": "Victory display (seconds)",
    },
    ...
    "widgets.common.duplicate": {"uk": "Дублювати", "en": "Duplicate"},
    "widgets.common.delete": {"uk": "Видалити", "en": "Delete"},
    ...
    "widgets.instances.editing_hint": {
        "uk": "«Зберегти» пише лише в цей інстанс. Дефолтний віджет не зміниться.",
        "en": "“Save” writes only to this instance. The default widget stays unchanged.",
    },
    "widgets.instances.name_placeholder": {
        "uk": "Назва віджета (напр. TikTok Top Likers)",
        "en": "Widget name (e.g. TikTok Top Likers)",
    },
    ...
    # Layout editor (canvas toolbar, widget library, layers, inspector)
    "widgets.layouts.editor.undo": {"uk": "Скасувати", "en": "Undo"},
    "widgets.layouts.editor.redo": {"uk": "Повторити", "en": "Redo"},
    "widgets.layouts.editor.preview": {"uk": "Показати preview", "en": "Show preview"},
    "widgets.layouts.editor.add_widget": {"uk": "Додати віджет", "en": "Add widget"},
    "widgets.layouts.editor.add_widget_hint": {
        "uk": "Перетягніть на полотно або натисніть +",
        "en": "Drag onto the canvas or press +",
    },
    "widgets.layouts.editor.search_ph": {"uk": "Пошук віджетів", "en": "Search widgets"},
    "widgets.layouts.editor.zoom_out": {"uk": "Зменшити масштаб", "en": "Zoom out"},
    "widgets.layouts.editor.zoom_in": {"uk": "Збільшити масштаб", "en": "Zoom in"},
    "widgets.layouts.editor.fit": {"uk": "Вписати", "en": "Fit"},
    "widgets.layouts.editor.fit_tip": {
        "uk": "Вписати всі віджети в область",
        "en": "Fit all widgets into view",
    },
    "widgets.layouts.editor.grid": {"uk": "Сітка", "en": "Grid"},
    "widgets.layouts.editor.grid_tip": {
        "uk": "Увімкнути сітку та прив'язку об'єктів",
        "en": "Enable grid and object snapping",
    },
    "widgets.layouts.editor.layers": {"uk": "Шари", "en": "Layers"},
    "widgets.layouts.editor.layers_hint": {"uk": "Порядок віджетів", "en": "Widget order"},
    "widgets.layouts.editor.layer_up": {"uk": "Підняти шар", "en": "Move layer up"},
    "widgets.layouts.editor.layer_down": {"uk": "Опустити шар", "en": "Move layer down"},
    "widgets.layouts.editor.lock": {"uk": "Заблокувати", "en": "Lock"},
    "widgets.layouts.editor.unlock": {"uk": "Розблокувати", "en": "Unlock"},
    "widgets.layouts.editor.hide": {"uk": "Сховати", "en": "Hide"},
    "widgets.layouts.editor.show": {"uk": "Показати", "en": "Show"},
    "widgets.layouts.editor.empty_layers": {
        "uk": "Додайте віджет з панелі зліва",
        "en": "Add a widget from the left panel",
    },
    "widgets.layouts.editor.canvas": {"uk": "Полотно", "en": "Canvas"},
    "widgets.layouts.editor.delete_widget": {"uk": "Видалити віджет", "en": "Delete widget"},
    "widgets.layouts.editor.saved": {"uk": "Збережено", "en": "Saved"},
    "widgets.layouts.editor.unsaved": {"uk": "Не збережено", "en": "Not saved"},
    "widgets.layouts.editor.select_hint": {
        "uk": "Виберіть віджет для редагування",
        "en": "Select a widget to edit",
    },
    "widgets.layouts.editor.preset_landscape": {
        "uk": "1920 × 1080 · Горизонталь",
        "en": "1920 × 1080 · Landscape",
    },
    "widgets.layouts.editor.preset_tiktok": {
        "uk": "1080 × 1920 · TikTok вертикаль",
        "en": "1080 × 1920 · TikTok vertical",
    },
    "widgets.layouts.editor.preset_square": {
        "uk": "1080 × 1080 · Квадрат",
        "en": "1080 × 1080 · Square",
    },
    "widgets.layouts.editor.preset_hd": {"uk": "1280 × 720 · HD", "en": "1280 × 720 · HD"},
    "widgets.layouts.editor.preset_custom": {"uk": "Вручну", "en": "Custom"},
    "widgets.layouts.editor.preset_tiktok_name": {
        "uk": "TikTok вертикаль",
        "en": "TikTok vertical",
    },
    "widgets.layouts.editor.preset_square_name": {"uk": "Квадрат", "en": "Square"},
    "widgets.layouts.editor.preset_hd_name": {"uk": "HD", "en": "HD"},
    # Widget type names / descriptions
    "widgets.type.chat.name": {"uk": "Чат", "en": "Chat"},
    "widgets.type.chat.desc": {"uk": "Оверлей чату трансляції.", "en": "Live stream chat overlay."},
    "widgets.type.actions.name": {"uk": "Дії та алерти", "en": "Actions & alerts"},
    "widgets.type.actions.desc": {"uk": "Алерти та дії.", "en": "Alerts and actions."},
    "widgets.type.activity.name": {"uk": "Активність", "en": "Activity"},
    "widgets.type.activity.desc": {"uk": "Стрічка активності.", "en": "Activity feed."},
    "widgets.type.online.name": {"uk": "Онлайн / глядачі", "en": "Online / viewers"},
    "widgets.type.online.desc": {"uk": "Лічильник онлайну.", "en": "Online viewers counter."},
    "widgets.type.top_likers.name": {"uk": "Топ лайкерів", "en": "Top Likers"},
    "widgets.type.top_likers.desc": {
        "uk": "Показує рейтинг користувачів за лайками.",
        "en": "Shows the user ranking by likes.",
    },
    "widgets.type.top_gifters.name": {"uk": "Топ GIFтерів", "en": "Top Gifters"},
    "widgets.type.top_gifters.desc": {
        "uk": "Показує рейтинг користувачів за подарунками.",
        "en": "Shows the user ranking by gifts.",
    },
    "widgets.type.king_of_live.name": {"uk": "King of the Live", "en": "King of the Live"},
    "widgets.type.king_of_live.desc": {"uk": "Король ефіру.", "en": "King of the stream."},
    "widgets.type.battle_royale.name": {"uk": "Battle Royale", "en": "Battle Royale"},
    "widgets.type.battle_royale.desc": {"uk": "Битва глядачів.", "en": "Viewer battle."},
    "widgets.type.battle.name": {"uk": "Battle", "en": "Battle"},
    "widgets.type.battle.desc": {
        "uk": "Битва 1v1: топ-2 GIFтери, раунди best-of.",
    ...
    "widgets.type.community_world.desc": {"uk": "Світ спільноти.", "en": "Community world."},
    "widgets.type.stream_goal.name": {"uk": "Stream Goal", "en": "Stream Goal"},
    ...
    "widgets.type.live_leaderboard_simple.name": {
        "uk": "Live Leaderboard Simple",
        "en": "Live Leaderboard Simple",
    },
    "widgets.type.live_leaderboard_simple.desc": {
        "uk": "Компактний лідерборд списком.",
        "en": "Compact list leaderboard.",
    },
    ...
    "widgets.type.webcam_frame.desc": {
        ...
        "en": "Camera frame (CAM/LINK).",
    },
    "widgets.type.signal_system.name": {"uk": "Signal System", "en": "Signal System"},
    "widgets.type.signal_system.desc": {"uk": "Сигнальна система.", "en": "Signal system."},
    "widgets.type.music.name": {"uk": "Музика", "en": "Music"},
    ...
    "widgets.gallery.total": {"uk": "Усього віджетів", "en": "Total widgets"},
    ...
    "widgets.gallery.cat_kick": {"uk": "Kick", "en": "Kick"},
    "widgets.gallery.cat_stream": {"uk": "Stream", "en": "Stream"},
    "widgets.gallery.cat_social": {"uk": "Social", "en": "Social"},
    "widgets.gallery.cat_interactive": {"uk": "Interactive", "en": "Interactive"},
    "widgets.gallery.platform_all": {"uk": "Усі платформи", "en": "All platforms"},
    ...
    # Splash screen
    "splash.loading": {"uk": "Завантаження…", "en": "Loading…"},
    "splash.starting": {"uk": "Запуск застосунку…", "en": "Starting application…"},
    "splash.widgets": {"uk": "Завантаження віджетів…", "en": "Loading widgets…"},
    "splash.layouts": {"uk": "Завантаження макетів…", "en": "Loading layouts…"},
