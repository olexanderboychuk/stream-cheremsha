...
_TABLE: dict[str, dict[AppLocale, str]] = {
    ...
    "widgets.battle.section_general": {"uk": "Загальні", "en": "General"},
    "widgets.battle.desc_general": {
        "uk": "Назва та базові правила битви 1v1.",
        "en": "Battle name and basic 1v1 rules.",
    },
    "widgets.battle.battle_name": {"uk": "Назва битви", "en": "Battle name"},
    "widgets.battle.best_of": {"uk": "Серія (best of)", "en": "Best of"},
    "widgets.battle.round_duration": {
        "uk": "Тривалість раунду",
        "en": "Round duration",
    },
    ...
    "widgets.battle.layout_mode": {"uk": "Компонування", "en": "Layout"},
    ...
    "widgets.battle.desc_behavior": {
        "uk": "Бали, комбо, камбек і фінальний ривок.",
    ...
    "widgets.battle.animation_intensity": {
        "uk": "Інтенсивність анімацій",
        "en": "Animation intensity",
    },
    "widgets.battle.show_badges": {"uk": "Бейджі подій", "en": "Event badges"},
    "widgets.battle.show_winner": {"uk": "Екран переможця", "en": "Winner screen"},
    "widgets.battle.victory_display": {
        "uk": "Тривалість екрана переможця (с)",
        "en": "Winner screen duration (sec)",
    },
    "widgets.battle.hide_when_idle": {"uk": "Ховати в очікуванні", "en": "Hide when idle"},
    "widgets.battle.font_family": {"uk": "Шрифт", "en": "Font"},
    "widgets.battle.decision_layer": {"uk": "Шар рішень (ШІ)", "en": "Decision layer (AI)"},
    ...
    "widgets.type.gift_rush.desc": {
        "uk": "Живі реакції на подарунки: монети та іскри.",
        "en": "Live reactions to gifts: coins and sparks.",
    },
