...
_TABLE: dict[str, dict[AppLocale, str]] = {
    ...
    "docksview.step2_title": {"uk": "Додайте у стрімінговий софт", "en": "Add to your streaming software"},
    ...
    "docksview.not_available": {"uk": "Docks API is not available yet.", "en": "Docks API is not available yet."},
    ...
    "actions.add_or_trigger_tt": {"uk": "Додати альтернативний тригер (АБО)", "en": "Add alternative trigger (OR)"},
    ...
    "widgets.battle_royale.section_behavior": {"uk": "Геймплей / поведінка", "en": "Gameplay / Behavior"},
    "widgets.battle_royale.section_advanced": {"uk": "Розширені", "en": "Advanced"},
    "widgets.battle_royale.desc_general": {"uk": "Основні налаштування цього інстансу.", "en": "Core settings for this widget instance."},
    "widgets.battle_royale.desc_appearance": {"uk": "Візуальне оформлення та відображення.", "en": "Visual presentation and display options."},
    "widgets.battle_royale.desc_behavior": {"uk": "Правила, час і поведінка віджета.", "en": "Rules, timing, and widget behavior."},
    "widgets.battle_royale.desc_advanced": {"uk": "Розширені налаштування віджета.", "en": "Advanced widget settings."},
    ...
    "widgets.battle_royale.critical_threshold": {"uk": "Поріг критичної атаки", "en": "Critical threshold"},
    "widgets.battle_royale.gifts_per_fighter": {"uk": "Подарунків на бійця", "en": "Gifts per fighter"},
    ...
    "widgets.battle_royale.automatic_threshold": {"uk": "Автоматичний поріг", "en": "Automatic threshold"},
    "widgets.battle_royale.automatic_window": {"uk": "Автоматичне вікно (секунди)", "en": "Automatic window (seconds)"},
    ...
    "widgets.battle_royale.critical_multiplier": {"uk": "Множник критичної атаки", "en": "Critical multiplier"},
    ...
    "widgets.battle_royale.animation_intensity": {"uk": "Інтенсивність анімації", "en": "Animation intensity"},
    "widgets.battle_royale.sfx_volume": {"uk": "Гучність SFX", "en": "SFX volume"},
    "widgets.battle_royale.projectile_animation": {"uk": "Анімація снарядів", "en": "Projectile animation"},
    ...
    "widgets.battle_royale.fatality_animation": {"uk": "Анімація фаталіті", "en": "Fatality animation"},
    "widgets.battle_royale.preset_arcade_royale": {"uk": "Аркадна королівська битва", "en": "Arcade Royale"},
    ...
    "widgets.battle_royale.preset_minimal_brawl": {"uk": "Мінімальна сутичка", "en": "Minimal Brawl"},
    ...
    "widgets.layouts.editor.preset_landscape": {"uk": "1920 × 1080 · Горизонталь", "en": "1920 × 1080 · Landscape"},
    "widgets.layouts.editor.preset_tiktok": {"uk": "1080 × 1920 · TikTok вертикаль", "en": "1080 × 1920 · TikTok vertical"},
    "widgets.layouts.editor.preset_square": {"uk": "1080 × 1080 · Квадрат", "en": "1080 × 1080 · Square"},
    "widgets.layouts.editor.preset_hd": {"uk": "1280 × 720 · HD", "en": "1280 × 720 · HD"},
    "widgets.layouts.editor.preset_custom": {"uk": "Вручну", "en": "Custom"},
    "widgets.layouts.editor.preset_tiktok_name": {"uk": "TikTok вертикаль", "en": "TikTok vertical"},
