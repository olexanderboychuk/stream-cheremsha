...
def test_match_chat_keyword_contains(text: str, keyword: str, case_sensitive: bool, expected: bool) -> None:
    assert match_chat_keyword(text, keyword, mode='contains', case_sensitive=case_sensitive) is expected
...
def test_match_chat_keyword_equals(text: str, keyword: str, case_sensitive: bool, expected: bool) -> None:
    assert match_chat_keyword(text, keyword, mode='equals', case_sensitive=case_sensitive) is expected
